...
func baseApi(apiV1 *gin.Engine) {
	api := apiV1.Group(config.Config().Yaml.Http.ApiBaseAPI).Group("/v1")
...
func resourceApi(apiV1 *gin.Engine) {
	api := apiV1.Group(config.Config().Yaml.Http.ResourceBaseAPI).Group("/v1")
